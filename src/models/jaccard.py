...
class JaccardThread(Thread):
    ...
    def run(self):
        ...
        print("end-find-common neighbors", self.idx)

        self.write_csv()
        print("end-run-thread", self.idx)


class Jaccard(Algorithm):
    def __init__(self,
                 id=None,
        ...
        super().__init__(name="Jaccard", id=id, setting={},
    ...
    def train(self,
        ...
        print("start- JaccardCoefficient", project_uid)
        lock = Lock()
    ...
    def get_step_list(self):
        step_list = [
            Step(
                name="Bước 1: Tính Jaccard Coefficient từ mỗi cặp nút trong mạng",
                inputs={
                    "CoNet1": "CoNet1",
                },
                outputs={
                    "Tập Jaccard Coefficient": "Tập cặp nút trong mạng kèm Jaccard Coefficient"
                },
                output_file=""),
            Step(
                name="Bước 2: Khuyến nghị theo số Jaccard Coefficient",
                inputs={
